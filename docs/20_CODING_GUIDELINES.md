...
reservation\_manager.h

reservation\_manager.cpp



deadlock\_detector.h

deadlock\_detector.cpp
...
Replanning R03 reason=HUMAN\_BLOCKAGE
...
static ReservationTable g\_table;
...
if (wait\_time > config.max\_wait\_time) {
...
reservation\_conflict\_is\_rejected

deadlock\_cycle\_is\_detected

planner\_no\_route\_returns\_error
